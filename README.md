...
[라이브 데모](https://glowfit-web.vercel.app) · [데모 영상](docs/assets/glowfit-demo.webm) · [60초 데모 스크립트](docs/demo-script.md) · [API Health](https://glowfit-api.vercel.app/health) · [Notion 포트폴리오 보기](https://app.notion.com/p/3996f7e3d828811fa0d7e358a783d6f6)
...
| 비교 | 적합도·근거 강도, 근거·주의 항목, 모델별 랭킹 신호를 같은 기준으로 비교합니다. |
...
> **GlowFit AI | Explainable Skincare Recommendation System** — Next.js·FastAPI·Supabase·Vercel 기반으로 100개 제품·1,074개 리뷰를 연결하고, 피부 프로필 기반 Top-3 추천과 리뷰 근거를 함께 제공한 개인 프로젝트.

이 문장을 이력서 프로젝트 항목의 첫 줄로 쓰고, 상세 설명에는 [데모 영상](docs/assets/glowfit-demo.webm)과 [케이스 스터디](docs/portfolio-case-study.md)를 연결하면 구현 범위와 의사결정 근거를 짧게 전달할 수 있습니다.
